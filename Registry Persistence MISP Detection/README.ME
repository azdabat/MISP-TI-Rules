...
```
/MISP-Integrated-Detections/
    ├── Registry-Persistence-MISP/
    │     ├── registry_persistence_misp.kql
    │     └── README.md
    ├── OAuth-Abuse-MISP/
    ├── DLL-Sideloading-MISP/
    ├── Port-Hunt-MISP/
    └── Supply-Chain-Pack/
```
...
# 📌 How to Create the Folder (Web UI)

1. Go to repo → **Add file → Create new file**  
2. Name it:  
   `MISP-Integrated-Detections/Registry-Persistence-MISP/README.md`  
3. Paste this README  
4. Commit  
5. Create file #2:  
   `registry_persistence_misp.kql`  
6. Paste the full rule and commit

---

If you want, I can now generate:

✅ **README for your MISP OAuth rule**  
✅ **README for your MISP DLL sideloading rule**  
✅ **README for your Supply-Chain Attack Pack (SolarWinds / 3CX / F5 / NTT Data / NotPetya)**  
✅ **Top-level README for your entire GitHub portfolio**

Just tell me:  
👉 *“Generate the full supply-chain pack README”* or  
👉 *“Generate all MISP rule READMEs”*
